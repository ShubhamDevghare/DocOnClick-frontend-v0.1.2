...
function initializeForms() {
    ...
    accountPreferencesForm.addEventListener('submit', function(e) {
        ...
        fetch(`http://localhost:8080/api/v1/doctors/${doctorId}/preferences`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
    ...
    notificationsForm.addEventListener('submit', function(e) {
        ...
        const notificationPreferences = {
            newAppointmentEmail: document.querySelector('[name="newAppointmentEmail"]').checked,
            newAppointmentSMS: document.querySelector('[name="newAppointmentSMS"]').checked,
            appointmentReminderEmail: document.querySelector('[name="appointmentReminderEmail"]').checked,
            appointmentReminderSMS: document.querySelector('[name="appointmentReminderSMS"]').checked,
            appointmentCancellationEmail: document.querySelector('[name="appointmentCancellationEmail"]').checked,
            appointmentCancellationSMS: document.querySelector('[name="appointmentCancellationSMS"]').checked,
            paymentReceivedEmail: document.querySelector('[name="paymentReceivedEmail"]').checked,
            paymentReceivedSMS: document.querySelector('[name="paymentReceivedSMS"]').checked,
            systemUpdatesEmail: document.querySelector('[name="systemUpdatesEmail"]').checked,
            systemUpdatesSMS: document.querySelector('[name="systemUpdatesSMS"]').checked
        };
        
        // Call API to update notification preferences
        fetch(`http://localhost:8080/api/v1/doctors/${doctorId}/notification-preferences`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json'
            },
...
// Main.js - Common functions for all doctor pages
document.addEventListener('DOMContentLoaded', function() {
